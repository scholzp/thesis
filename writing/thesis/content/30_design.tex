...
it is an open question I will investigate in chapter~\ref{eval}\todo{correct
    reference}. TEECore also protects against interrupt-based single-stepping
attacks like SGX-Step (\todo{verwies auf attacks}). With the special
