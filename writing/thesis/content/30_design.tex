...
snoops are documented behavior of all recent Intel CPUs\cite{sdm}. Nevertheless,
I want to mention that this is a requirement for TEECore to work. Other possible
cache implementations, for example, that would push changes of shared cache
lines to remote cores, would not work with TEECore.\\
...
\gls{vmm} could skip all checks implemented in TEECore and inject result of
