...
applications} As a target for the prototype implementation of TEECore I used an
...
first-stage bootloader\todo{maybe this is not a multi-stage bootloader} that
...
(c.f.~\ref{sec:implementation:attacks:memory})\todo{referenz prüfne}. While
...
because... \todo{Add a plausible cause}. As a result, I decided to use the
